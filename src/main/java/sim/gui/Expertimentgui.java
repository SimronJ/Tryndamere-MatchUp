			...
			gl_ctpMainBackground.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_ctpMainBackground.createSequentialGroup()
					...
					.addGroup(gl_ctpMainBackground.createParallelGroup(Alignment.LEADING)
						.addComponent(lblAllyPlayer5, GroupLayout.DEFAULT_SIZE, 81, Short.MAX_VALUE)
						.addComponent(lblAllyPlayer4, GroupLayout.DEFAULT_SIZE, 81, Short.MAX_VALUE)
						.addComponent(lblAllyPlayer3, GroupLayout.DEFAULT_SIZE, 81, Short.MAX_VALUE)
						.addComponent(lblAllyPlayer2, GroupLayout.DEFAULT_SIZE, 81, Short.MAX_VALUE)
						.addComponent(lblAllyPlayer1, GroupLayout.DEFAULT_SIZE, 81, Short.MAX_VALUE)
						.addGroup(gl_ctpMainBackground.createSequentialGroup()
							.addGap(6)
					...
					.addGroup(gl_ctpMainBackground.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_ctpMainBackground.createSequentialGroup()
							...
							.addGap(18)
							.addComponent(lblDiffLabel, GroupLayout.DEFAULT_SIZE, 159, Short.MAX_VALUE))
						.addComponent(champTextPaneSP)
						.addGroup(gl_ctpMainBackground.createSequentialGroup()
							...
							.addGroup(gl_ctpMainBackground.createParallelGroup(Alignment.LEADING, false)
								...
								.addComponent(btnStopButton_1, Alignment.TRAILING, GroupLayout.PREFERRED_SIZE, 67, GroupLayout.PREFERRED_SIZE))
							.addGroup(gl_ctpMainBackground.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_ctpMainBackground.createSequentialGroup()
					...
					.addGap(42)
					.addGroup(gl_ctpMainBackground.createParallelGroup(Alignment.LEADING)
						.addComponent(lblEnemyPlayer1, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 81, Short.MAX_VALUE)
						.addComponent(lblEnemyPlayer2, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 81, Short.MAX_VALUE)
						.addComponent(lblEnemyPlayer3, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 81, Short.MAX_VALUE)
						.addComponent(lblEnemyPlayer4, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 81, Short.MAX_VALUE)
						.addComponent(lblEnemyPlayer5, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 81, Short.MAX_VALUE)
