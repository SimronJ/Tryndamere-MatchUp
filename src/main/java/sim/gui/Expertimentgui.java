...
public class Expertimentgui
{
	 ...
	 * Create the frame.
	 */
//	public Expertimentgui()
//	{
//		setTitle("Simron GuideOutLoud");
...
//				{
//					Thread.sleep(1000);
////					lblAllyPlayer1.removeAll();
////					lblAllyPlayer1.revalidate();
////					lblAllyPlayer1.repaint();
////					lblAllyPlayer1.setIcon(new ImageIcon(new javax.swing.ImageIcon(getClass().getResource("/sim/resources/champs/" + getandsetchamps.getAllyplayer1() + ".png")).getImage().getScaledInstance(imginewh, imginewh, Image.SCALE_SMOOTH)));
////					
////					lblAllyPlayer2.removeAll();
////					lblAllyPlayer2.revalidate();
////					lblAllyPlayer2.repaint();
////					lblAllyPlayer2.setIcon(new ImageIcon(new javax.swing.ImageIcon(getClass().getResource("/sim/resources/champs/" + getandsetchamps.getAllyplayer2() + ".png")).getImage().getScaledInstance(imginewh, imginewh, Image.SCALE_SMOOTH)));
////					
////					lblAllyPlayer3.removeAll();
////					lblAllyPlayer3.revalidate();
////					lblAllyPlayer3.repaint();
////					lblAllyPlayer3.setIcon(new ImageIcon(new javax.swing.ImageIcon(getClass().getResource("/sim/resources/champs/" + getandsetchamps.getAllyplayer3() + ".png")).getImage().getScaledInstance(imginewh, imginewh, Image.SCALE_SMOOTH)));
////					
////					lblAllyPlayer4.removeAll();
////					lblAllyPlayer4.revalidate();
////					lblAllyPlayer4.repaint();
////					lblAllyPlayer4.setIcon(new ImageIcon(new javax.swing.ImageIcon(getClass().getResource("/sim/resources/champs/" + getandsetchamps.getAllyplayer4() + ".png")).getImage().getScaledInstance(imginewh, imginewh, Image.SCALE_SMOOTH)));
////					
////					lblAllyPlayer5.removeAll();
////					lblAllyPlayer5.revalidate();
////					lblAllyPlayer5.repaint();
////					lblAllyPlayer5.setIcon(new ImageIcon(new javax.swing.ImageIcon(getClass().getResource("/sim/resources/champs/" + getandsetchamps.getAllyplayer5() + ".png")).getImage().getScaledInstance(imginewh, imginewh, Image.SCALE_SMOOTH)));
////					
//					/////////////////////////////////////////////////ENEMT STARTS HERE/////////////////////////////////////////////////////////////////
//					
//					lblEnemyPlayer1.removeAll();
//					lblEnemyPlayer1.revalidate();
//					lblEnemyPlayer1.repaint();
//					lblEnemyPlayer1.setIcon(new ImageIcon(new javax.swing.ImageIcon(getClass().getResource("/sim/resources/champs/" + getandsetchamps.getEnemyplayer1() + ".png")).getImage().getScaledInstance(imginewh, imginewh, Image.SCALE_SMOOTH)));
//					
//					lblEnemyPlayer2.removeAll();
//					lblEnemyPlayer2.revalidate();
//					lblEnemyPlayer2.repaint();
//					lblEnemyPlayer2.setIcon(new ImageIcon(new javax.swing.ImageIcon(getClass().getResource("/sim/resources/champs/" + getandsetchamps.getEnemyplayer2() + ".png")).getImage().getScaledInstance(imginewh, imginewh, Image.SCALE_SMOOTH)));
//					
//					lblEnemyPlayer3.removeAll();
//					lblEnemyPlayer3.revalidate();
//					lblEnemyPlayer3.repaint();
//					lblEnemyPlayer3.setIcon(new ImageIcon(new javax.swing.ImageIcon(getClass().getResource("/sim/resources/champs/" + getandsetchamps.getEnemyplayer3() + ".png")).getImage().getScaledInstance(imginewh, imginewh, Image.SCALE_SMOOTH)));
//					
//					lblEnemyPlayer4.removeAll();
//					lblEnemyPlayer4.revalidate();
//					lblEnemyPlayer4.repaint();
//					lblEnemyPlayer4.setIcon(new ImageIcon(new javax.swing.ImageIcon(getClass().getResource("/sim/resources/champs/" + getandsetchamps.getEnemyplayer4() + ".png")).getImage().getScaledInstance(imginewh, imginewh, Image.SCALE_SMOOTH)));
//					
//					lblEnemyPlayer5.removeAll();
//					lblEnemyPlayer5.revalidate();
//					lblEnemyPlayer5.repaint();
//					lblEnemyPlayer5.setIcon(new ImageIcon(new javax.swing.ImageIcon(getClass().getResource("/sim/resources/champs/" + getandsetchamps.getEnemyplayer5() + ".png")).getImage().getScaledInstance(imginewh, imginewh, Image.SCALE_SMOOTH)));
//					
//				}
//			}
//			
...
//	}
	...
	//////////////////////////////////////////////
	// Code for creating and init components
	/////////////////////////////////////////////
	private static void initComponents()
	{
		...
		lblAllyPlayer5.setIcon(new ImageIcon(new javax.swing.ImageIcon(Expertimentgui.class.getResource("/sim/resources/champs/none.png")).getImage().getScaledInstance(imginewh, imginewh, Image.SCALE_SMOOTH)));

		lblAllyPlayer4 = new JLabel("");
		lblAllyPlayer4.setForeground(Color.BLACK);
		lblAllyPlayer4.setBackground(SystemColor.desktop);
		lblAllyPlayer4.setIcon(new ImageIcon(new javax.swing.ImageIcon(Expertimentgui.class.getResource("/sim/resources/champs/none.png")).getImage().getScaledInstance(imginewh, imginewh, Image.SCALE_SMOOTH)));

		lblAllyPlayer3 = new JLabel("");
		lblAllyPlayer3.setForeground(Color.BLACK);
		lblAllyPlayer3.setBackground(SystemColor.desktop);
		lblAllyPlayer3.setIcon(new ImageIcon(new javax.swing.ImageIcon(Expertimentgui.class.getResource("/sim/resources/champs/none.png")).getImage().getScaledInstance(imginewh, imginewh, Image.SCALE_SMOOTH)));
		
		lblAllyPlayer2 = new JLabel("");
		lblAllyPlayer2.setForeground(Color.BLACK);
		lblAllyPlayer2.setBackground(SystemColor.desktop);
		lblAllyPlayer2.setIcon(new ImageIcon(new javax.swing.ImageIcon(Expertimentgui.class.getResource("/sim/resources/champs/none.png")).getImage().getScaledInstance(imginewh, imginewh, Image.SCALE_SMOOTH)));
		
		lblAllyPlayer1 = new JLabel("");
		lblAllyPlayer1.setForeground(Color.BLACK);
		lblAllyPlayer1.setBackground(SystemColor.desktop);
		lblAllyPlayer1.setIcon(new ImageIcon(new javax.swing.ImageIcon(Expertimentgui.class.getResource("/sim/resources/champs/none.png")).getImage().getScaledInstance(imginewh, imginewh, Image.SCALE_SMOOTH)));
		...
		lblEnemyPlayer1.setIcon(new ImageIcon(new javax.swing.ImageIcon(Expertimentgui.class.getResource("/sim/resources/champs/none.png")).getImage().getScaledInstance(imginewh, imginewh, Image.SCALE_SMOOTH)));

		lblEnemyPlayer2 = new JLabel("");
		lblEnemyPlayer2.setForeground(Color.BLACK);
		lblEnemyPlayer2.setBackground(SystemColor.desktop);
		lblEnemyPlayer2.setIcon(new ImageIcon(new javax.swing.ImageIcon(Expertimentgui.class.getResource("/sim/resources/champs/none.png")).getImage().getScaledInstance(imginewh, imginewh, Image.SCALE_SMOOTH)));

		lblEnemyPlayer3 = new JLabel("");
		lblEnemyPlayer3.setForeground(Color.BLACK);
		lblEnemyPlayer3.setBackground(SystemColor.desktop);
		lblEnemyPlayer3.setIcon(new ImageIcon(new javax.swing.ImageIcon(Expertimentgui.class.getResource("/sim/resources/champs/none.png")).getImage().getScaledInstance(imginewh, imginewh, Image.SCALE_SMOOTH)));

		lblEnemyPlayer4 = new JLabel("");
		lblEnemyPlayer4.setForeground(Color.BLACK);
		lblEnemyPlayer4.setBackground(SystemColor.desktop);
		lblEnemyPlayer4.setIcon(new ImageIcon(new javax.swing.ImageIcon(Expertimentgui.class.getResource("/sim/resources/champs/none.png")).getImage().getScaledInstance(imginewh, imginewh, Image.SCALE_SMOOTH)));

		lblEnemyPlayer5 = new JLabel("");
		lblEnemyPlayer5.setForeground(Color.BLACK);
		lblEnemyPlayer5.setBackground(SystemColor.desktop);
		lblEnemyPlayer5.setIcon(new ImageIcon(new javax.swing.ImageIcon(Expertimentgui.class.getResource("/sim/resources/champs/none.png")).getImage().getScaledInstance(imginewh, imginewh, Image.SCALE_SMOOTH)));
		...
		champTextPaneSP = new JScrollPane(champTextPane,
				...
				.addGroup(gl_ctpMainBackground.createSequentialGroup()
					.addGroup(gl_ctpMainBackground.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_ctpMainBackground.createSequentialGroup()
							...
							.addGap(18)
							.addComponent(champTextPaneSP, GroupLayout.DEFAULT_SIZE, 157, Short.MAX_VALUE)
							.addPreferredGap(ComponentPlacement.RELATED)
						...
						.addGroup(gl_ctpMainBackground.createSequentialGroup()
							...
							.addGroup(gl_ctpMainBackground.createParallelGroup(Alignment.TRAILING)
								.addGroup(gl_ctpMainBackground.createSequentialGroup()
									...
									.addGap(11)
									.addComponent(lblEnemyPlayer5, GroupLayout.PREFERRED_SIZE, 67, Short.MAX_VALUE))
								.addGroup(gl_ctpMainBackground.createSequentialGroup()
									.addComponent(lblAllyText)
									.addGap(8)
									...
									.addPreferredGap(ComponentPlacement.UNRELATED)
									.addComponent(lblAllyPlayer4, GroupLayout.PREFERRED_SIZE, 68, Short.MAX_VALUE)
									.addPreferredGap(ComponentPlacement.UNRELATED)
	...
	private static void createEvents()
	{
		lblEnemyPlayer1.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if(tem[1].equals("Easy")) {lblDiffLabel.setForeground(Color.GREEN);};
				if(tem[1].equals("Medium")) {lblDiffLabel.setForeground(Color.BLUE);};
				if(tem[1].equals("Hard")) {lblDiffLabel.setForeground(Color.RED);};
				if(tem[1].equals("INTeresting")) {lblDiffLabel.setForeground(Color.MAGENTA);};
				if(tem[1].equals("Trolling")) {lblDiffLabel.setForeground(Color.CYAN);};
				if(tem[1].equals("Unknown")) {lblDiffLabel.setForeground(Color.DARK_GRAY);};
